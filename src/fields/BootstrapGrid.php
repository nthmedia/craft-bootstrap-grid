...
class BootstrapGrid extends Field
{
    ...
    {
        return Craft::t('bootstrap-grid', 'Bootstrap Grid');
    }
...
//        ]);
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(BootstrapGridFieldAsset::class);
        ...
        return Craft::$app->getView()->renderTemplate(
            'bootstrap-grid/_components/fields/BootstrapGrid_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
